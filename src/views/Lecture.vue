      ...
      <div class="row">
        <div class="col">
          ...
          >
            ...
            <el-table-column prop="name" label="Lecture name">
            </el-table-column>
            ...
            <el-table-column label="Video" #default="scope">
              <iframe width="200" height="150" :src="scope.row.videoUrl">
              </iframe>
            </el-table-column>
      ...
      >
        ...
        <el-form ref="form" :model="sizeForm" label-width="120px" size="mini">
          ...
          <el-form-item label="Video url">
            <el-input v-model="sizeForm.videoUrl"></el-input>
            <iframe width="200" height="150" :src="sizeForm.videoUrl"> </iframe>
          </el-form-item>
  ...
  methods: {
    setPage(val) {
      ...
      this.keyword !== ""
        ...
        : Api.get("/lecture", { params: { page: this.page, limit: 100 } })
            .then((res) => {
              this.tableData = res.data.data;
              this.loading = false;
              this.total = res.data.total;
    ...
    handleDelete(index, row) {
      this.lectureId = row._id;
      ElMessageBox.confirm("Are you sure to delete this lecture?")
        .then(() => {
          this.loading_delete_btn;
          Api.delete(`/lecture/${this.lectureId}`)
            .then(() => {
              this.$notify({
                type: "success",
    ...
    onSubmit() {
      ...
      Api.put(`/lecture/${this.lectureId}`, {
        name: this.sizeForm.name,
        description: this.sizeForm.description,
        bannerImg: this.sizeForm.bannerImg,
        videoUrl: this.sizeForm.videoUrl,
      })
        .then(() => {
          this.$notify({
            type: "success",
            title: "Update lecture",
            message: "Update lecture successful",
          });

      ...
      <div class="row">
        ...
        fileName: "", -->
          ...
          >
            ...
            <el-table-column prop="exerciseName" label="Exercise Name">
            </el-table-column>
            <el-table-column prop="typeOfExams" label="Type of exam">
            </el-table-column>
            ...
            <el-table-column label="Exam file" #default="scope">
              <el-upload
                class="upload-demo"
                action="https://jsonplaceholder.typicode.com/posts/"
                :file-list="[
                  { name: scope.row.fileName, url: scope.row.examFileUrl },
                ]"
                :disabled="true"
                :thumbnail-mode="true"
              >
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      Api.put(`/exercise/${this.exerciseId}`, {
